...
Videre skal vi presentere ulike teorier som vi skal bruke til å beskrive trender i befolknignsveksten på et regionalt nivå.
...
"Den grunnleggende ideen for å beskrive regionale veksthastigheter påvirkes dette av tre faktorer i form av" (kilde; powerpoint kap 4):

-   Den industrielle strukturen

-   Sektorens produktivitet

-   Dynamikken i etterspørsel og forbrukerpreferanser

    Både den "industrielle strukturen" og "sektorens produktivitet" ligger utenfor variablene i vårt datasett, men vil være høyaktuelt å utforske nærmere ved videre forskning da de er avgjørende faktorer som påvirker befolkningsveksten.

    Det vil da i denne "oppgaven" bli lagt vekt på dynamikken mellom etterspørsel og forbrukerpreferanser, hvor man skiller dette mellom å være Mix - effekter (etterspørselsside elementer) og Dif - effekter (tilbudsside elementer) som avgjør denne dynamikken.

    Mix- effekter (etterspørsel):...

    "Konkurranseeffekten (differensiell forskyvning); 'DIF-effekten', stammer fra den regionale økonomiens evne til å utvikle sine sektorer med høyere gjennomsnittlige veksthastigheter enn de oppnådde av tilsvarende nasjonale sektorer." powerpont kap 4 s.
    14

    Momenter:

    Tidligere forskning viser til at "Mikroøkonomiske faktorer som konkurranse mellom byer, kjøpekraft og tomtepriser og markedssvikt spiller også en rolle. For eksempel kan sentralisering til byene bidra til økt press på boliger og priser. Tomteprisen er gjerne høyest i sentrum. Det kan dermed være billigere å anskaffe leiligheter som er lokalisert i områder utenfor sentrum med lavere tetthet"(Artikkel. s. 2).

    "Byer må vokse for å imøtekomme en voksende befolkning" (kilde artikkel s. 1),

Williamson´s inverterte U:
...
Gruppe 2 har hatt en svært mye større vekst enn de andre gruppene... Dersom vi filtrerer og setter den relative veksten til under 200, ser vi at de fleste gruppene har hatt en relativ liten og stabil vekst.
